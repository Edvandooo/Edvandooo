...
<head>
    ...
    <title>F.E Sousa · interface</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <header class="hero-header">
        <div class="hero-grid">
            <div class="hero-left">
                <h1>Francisco Edvando<br><span style="font-size:2.2rem; background:linear-gradient(135deg,#00D9FF,#7C3AED); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">F.E Sousa</span></h1>
                <div class="sub">
                ...
                <div style="margin-top:1.2rem; display:flex; gap:0.4rem; flex-wrap:wrap;">
                    ...
                    <span class="tag" style="background:#00D9FF10; border-color:#00D9FF30;">IA</span>
            ...
            <div class="hero-right">
                ...
                <div class="sys-line"><span>FOCUS</span><span class="val">Python · IA</span></div>
    ...
    <!-- ═══ WIDGETS: sobre / status ═══ -->
    <div class="widget-grid">
        <div class="widget-card"><div class="widget-label">💻 foco</div><div class="widget-value">Python · Automação · IA</div></div>
        <div class="widget-card"><div class="widget-label">📚 estudando</div><div class="widget-value"><span class="highlight">Python</span> · Git · Godot</div></div>
        <div class="widget-card"><div class="widget-label">🎯 objetivo</div><div class="widget-value">primeira vaga dev</div></div>
        <div class="widget-card"><div class="widget-label">🚀 projetos</div><div class="widget-value">em evolução</div></div>
    </div>

    <!-- ═══ BENTO: about + tech + roadmap ═══ -->
    <div class="grid-bento">
        <div class="bento-item span-3">
            <div style="font-size:0.6rem; letter-spacing:0.1em; color:#64748B; text-transform:uppercase;">sobre</div>
            <p style="margin-top:0.5rem; color:#CBD5E1; font-size:0.95rem; line-height:1.5;">
                Estudante de desenvolvimento de software, criando projetos para evoluir e transformar ideias em código. 
                Foco em automação, IA e ferramentas práticas.
            </p>
        </div>
        <div class="bento-item span-5">
            ...
            <div style="display:flex; flex-wrap:wrap; gap:0.5rem; margin-top:0.7rem;">
                ...
                <span class="tag" style="background:#0F172A;">Automação</span>
                <span class="tag" style="background:#0F172A;">IA</span>
        ...
        <div class="bento-item span-4">
            ...
            <div class="progress-track" style="margin-top:0.8rem;">
                ...
                <div class="progress-item"><span class="label">IA</span><div class="progress-bar-bg"><div class="progress-fill" style="width:30%;"></div></div></div>
    ...
    <div style="margin-top:2.5rem;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
            ...
            <span class="tag" style="background:#0F172A;">progresso</span>
        </div>
        ...
        <div style="margin-top:0.8rem; display:grid; grid-template-columns:2fr 1fr; gap:1rem;">
            <div class="analytics-card" style="padding:0.8rem 1.2rem;">
                ...
                <div style="display:flex; gap:0.2rem; flex-wrap:wrap; margin-top:0.3rem;">
                    <span style="background:#0F172A; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#0F172A; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#2563EB40; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#00D9FF30; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#7C3AED30; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#0F172A; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#00D9FF30; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                    <span style="background:#0F172A; padding:0.1rem 0.4rem; border-radius:4px; font-size:0.6rem;">▮</span>
                </div>
            </div>
            <div class="analytics-card" style="display:flex; align-items:center; gap:0.5rem;">
                <span style="font-size:0.7rem; color:#64748B;">🐍 snake</span>
                <span style="font-size:0.8rem; color:#00D9FF;">~</span>
                <span style="font-size:0.6rem; color:#94A3B8;">em progresso</span>
            </div>
        </div>
    </div>

    <!-- ═══ QUOTE ═══ -->
    <div class="quote-block" style="margin-top:2.5rem;">
        <div class="quote-text">“Transformando ideias em código, uma linha de cada vez.”</div>
        <div class="quote-author">— Francisco Edvando Sousa</div>
    </div>

    <!-- ═══ FOOTER ═══ -->
    <footer class="footer-premium">
        <div class="brand">F.E Sousa · 2026</div>
        <div class="foot-links">
            <span>✦ github/Edvandooo</span>
            <span>✦ automação</span>
            <span>✦ IA</span>
            <span>✦ godot</span>
        </div>
        <div style="display:flex; gap:0.3rem;">
            <span class="tag" style="background:#0F172A;">✧</span>
            <span class="tag" style="background:#0F172A;">✧</span>
        </div>
    </footer>
